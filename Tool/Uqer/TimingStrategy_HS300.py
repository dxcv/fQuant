# -*- coding: utf-8 -*-
"""
Created on Sat Jun 10 18:44:22 2017

@author: freefrom
"""

"""
简单择时策略：上涨趋势确认，全仓买入沪深300ETF；下跌趋势确认，空仓。

由于沪深300指数ETF于2012年5月28日上市：华泰柏瑞沪深300ETF（510300）和嘉实沪深300ETF（159919），所以，我们采用买入沪深300指数成分股来做模拟。
日线数据最早支持到2006年1月1日，分钟线数据最早支持到2009年1月1日。所以，测试从2006年1月1日开始。
历史日线首个交易日为2006年1月4日，为了配合测试，我们舍弃了前几个趋势分段，并新加入了2006年1月5日作为首个趋势段。
注意由于2006年1月4日为首个历史交易日，如果选这一天作为调仓日，那么account.reference_price会由于取不到前一交易日的价格，而取 0.0。
"""
...
timing_fn = 'Timing/Timing_Index_000300_0.05.csv'
...
"""
择时策略全周期测试：2006-01-01 到 2017-04-30
"""
...
"""
择时策略近周期测试：2014-01-01 到 2017-04-30
"""
...
"""
择时策略中周期测试：2009-01-01 到 2013-12-31
"""
...
"""
择时策略远周期测试：2006-01-01 到 2008-12-31
"""
